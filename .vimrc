...
Plugin 'tComment'		 	" Easy to use, file-type sensible comments
...
"Plugin 'vim-airline/vim-airline'       " vim-airlne conflict with plugin 'vim-airline/vim-airline'
...
" Запуск консоли python на F11
nnoremap <F11> :ConqueTermSplit python<CR>

" Запуск консоли bash на F12
